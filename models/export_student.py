...
class ExportStudent(models.Model):
    ...
    # Nom de la base de donnée à crée
        ...
        for student in self.student_ids.sorted(key=lambda x: x.partner_id.name):
            ...
            if self.student_contact_information:
                ...
                if row == 0:
                    ...
                    libelles = ('Enfant - Adresse', 'Enfant - Date de naissance', 'Enfant - Lieu de naissance')
                    for libelle in libelles:
                        worksheet.write(row, column_libelle, libelle, for_left)
                        column_libelle += 1
                values_list = (student.partner_id.street, school_birthdate, student.school_place_of_birth.name)
            ...
            if self.responsible_school_contact_information:
                if row == 0:
                    ...
                    for libelle in libelles:
                        worksheet.write(row, column_libelle, libelle, for_left)
                        column_libelle += 1
                values_list = (student.school_responsible_partner.street, student.school_responsible_partner.email)
                for value_list in values_list:
                    if not value_list:
                        value_list = ""
                    worksheet.write(row+1, column, value_list, for_left_not_bold)
            ...
            if self.student_school_catering_information:
                ...
                if row == 0:
                    ...
                    libelles = ('Rest. - Inscrit', 'Rest. - Lieu', 'Rest.- Début',
                                ...
                                'Resp. - Nom et prénom', 'Resp. - Tél. 1', 'Res. - Tél. 2')
                    for libelle in libelles:
                        worksheet.write(row, column_libelle, libelle, for_left)
                        column_libelle += 1
            ...
            if self.responsible_nursery_contact_information:
                if row == 0:
                    ...
                    for libelle in libelles:
                        worksheet.write(row, column_libelle, libelle, for_left)
                        column_libelle += 1
                values_list = (student.nursery_responsible_partner.street, student.nursery_responsible_partner.email)
                for value_list in values_list:
                    if not value_list:
                        value_list = ""
                    worksheet.write(row+1, column, value_list, for_left_not_bold)
